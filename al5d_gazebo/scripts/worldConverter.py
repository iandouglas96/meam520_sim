...
def convertTextString(origin, size, number):
    ...
    output = output + indent + indent + indent + "<origin xyz = \"" + str(origin[0]) + " " + str(origin[1]) + " " + str(origin[2]) + "\" "
    output = output + "rpy = \"0 0 0\" /> \n"
    output = output + indent + indent + indent + "<geometry> \n"
    output = output + indent + indent + indent + indent + "<box size=\"" + str(size[0]) + " " + str(size[1]) + " " + str(size[2]) + "\" />\n"
    output = output + indent + indent + indent + "</geometry> \n"
    output = output + indent + indent + "</visual> \n"
